      ...
      if (statusCode == HttpStatus.SC_OK) {
        ...
        case SC_UNAUTHORIZED:
          throw new MavenValidationException(
              new Issue(Severity.WARNING, MavenResolver.class, project,
                  MavenProjectExt.class, MavenReactorProjectExt.PROPERTY_MAVEN_REACTOR,
                  MessageFormat.format("{0} found but authentication required", url, statusCode, statusText)));
        ...
        case SC_INSUFFICIENT_STORAGE:
          throw new MavenValidationException(
              new Issue(Severity.WARNING, MavenResolver.class, project,
                  MavenProjectExt.class, MavenReactorProjectExt.PROPERTY_MAVEN_REACTOR,
                  MessageFormat.format("{0} not found. Host reports a temporary problem: {1} {2}", url, statusCode, statusText)));
        ...
        default:
          throw new MavenValidationException(
              new Issue(Severity.ERROR, MavenResolver.class, project,
                  MavenProjectExt.class, MavenReactorProjectExt.PROPERTY_MAVEN_REACTOR,
                  MessageFormat.format("{0} not found. Host responded with {1} {2}", url, statusCode, statusText)));
        }
      }
    } finally {

...
public class MavenCoordinateTest {
  ...
  public void testCompare() throws Exception {
    ...
    MavenCoordinate right = new MavenCoordinate("com.example.test", MavenCoordinateUtil.ARTIFACT, MavenCoordinateUtil.PACKAGING);
    ...
    right = new MavenCoordinate(MavenCoordinateUtil.GROUPID.toUpperCase(), MavenCoordinateUtil.ARTIFACT, MavenCoordinateUtil.PACKAGING);
    assertTrue(left.compareTo(right)!=0);

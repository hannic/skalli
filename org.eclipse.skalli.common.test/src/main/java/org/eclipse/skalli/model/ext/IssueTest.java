...
public class IssueTest implements Issuer {
  ...
  public void testBasics() {
    ...
    Assert.assertEquals(MessageFormat.format("Entity {0} is invalid", PropertyHelperUtils.TEST_UUIDS[0].toString()), issue.getMessage());
    ...
    issue = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_STR);
    Assert.assertEquals(Severity.WARNING, issue.getSeverity());
    Assert.assertEquals(ISSUER, issue.getIssuer());
    Assert.assertEquals(PropertyHelperUtils.TEST_UUIDS[0], issue.getEntityId());
    Assert.assertEquals(MessageFormat.format("Property {0} of extension {1} of entity {2} is invalid",
        TestExtension.PROPERTY_STR, TestExtension.class.getName(), PropertyHelperUtils.TEST_UUIDS[0].toString()),
        issue.getMessage());
    Assert.assertEquals(TestExtension.class.getName(), issue.getExtension().getName());
    Assert.assertEquals(TestExtension.PROPERTY_STR, issue.getPropertyId());
    Assert.assertNull(issue.getDescription());

    issue = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_STR, "message");
  ...
  public void testCompareToEquals() {
    ...
    Assert.assertFalse(issue.equals(issue1));
    Assert.assertFalse(issue1.equals(issue));
    Assert.assertEquals(PropertyHelperUtils.TEST_UUIDS[0].compareTo(PropertyHelperUtils.TEST_UUIDS[1]), issue.compareTo(issue1));
    Assert.assertEquals(PropertyHelperUtils.TEST_UUIDS[1].compareTo(PropertyHelperUtils.TEST_UUIDS[0]), issue1.compareTo(issue));
    ...
    issue = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL);
    issue1 = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_STR);
    Assert.assertFalse(issue.equals(issue1));
    Assert.assertFalse(issue1.equals(issue));
    Assert.assertTrue(issue.compareTo(issue1) < 0);
    Assert.assertTrue(issue1.compareTo(issue) > 0);
    ...
    issue = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL, "foo");
    issue1 = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL, "bar");
    Assert.assertTrue(issue.equals(issue1));
    Assert.assertTrue(issue1.equals(issue));

    issue = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL, "foo");
    issue1 = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL, null);
    Assert.assertTrue(issue.equals(issue1));
    Assert.assertTrue(issue1.equals(issue));

    issue = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL, null);
    issue1 = new Issue(Severity.WARNING, ISSUER, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL, "bar");
    Assert.assertTrue(issue.equals(issue1));
    Assert.assertTrue(issue1.equals(issue));

    issue = new Issue(Severity.WARNING, SomeIssuer.class, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL);
    issue1 = new Issue(Severity.WARNING, AnotherIssuer.class, PropertyHelperUtils.TEST_UUIDS[0], TestExtension.class, TestExtension.PROPERTY_BOOL);
    Assert.assertFalse(issue.equals(issue1));
    Assert.assertFalse(issue1.equals(issue));
    Assert.assertTrue(issue.compareTo(issue1) > 0);
    Assert.assertTrue(issue1.compareTo(issue) < 0);

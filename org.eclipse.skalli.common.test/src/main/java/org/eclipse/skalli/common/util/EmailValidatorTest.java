...
public class EmailValidatorTest {
  ...
  public void testIsValid() throws Exception {
    EmailValidator validator = new EmailValidator(Severity.FATAL, TestExtension.class, TestExtension.PROPERTY_STR, "proj.*");
    ...
    Assert.assertTrue(validator.isValid(PropertyHelperUtils.TEST_UUIDS[0], "homer!#$%&'*+-/=?^_`{|}~blab.lubb@springfield.org"));
  ...
  public void testValidate() throws Exception {
    ...
    SortedSet<Issue> issues = validator.validate(PropertyHelperUtils.TEST_UUIDS[0], "homer@springfield.org", Severity.FATAL);
  ...
  public void testInvalidMessages() {
    ...
    EmailValidator validator = new EmailValidator(Severity.FATAL, TestExtension.class, TestExtension.PROPERTY_STR, "EMail");
    ...
    validator = new EmailValidator(Severity.FATAL, TestExtension.class, TestExtension.PROPERTY_STR, "Invalid EMail", "Undefined EMail");
    issues = validator.validate(PropertyHelperUtils.TEST_UUIDS[0], value, Severity.FATAL);

...
public abstract class AbstractPropertyValidator implements PropertyValidator, Issuer {
   ...
   */
  protected AbstractPropertyValidator(Severity severity, Class<? extends ExtensionEntityBase> extension, String propertyName) {
    if (severity == null) {
   ...
   */
  protected AbstractPropertyValidator(Severity severity, Class<? extends ExtensionEntityBase> extension, String propertyName, String caption) {

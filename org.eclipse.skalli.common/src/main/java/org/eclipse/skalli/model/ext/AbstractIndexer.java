...
public abstract class AbstractIndexer<T extends EntityBase> {
  ...
  protected final void addField(String fieldName, String value, boolean stored, boolean indexed) {
    if (!StringUtils.isEmpty(value)) {
      IndexEntry field = new IndexEntry(fieldName, value, stored ? IndexEntry.Stored.YES : IndexEntry.Stored.NO, indexed ? IndexEntry.Indexed.TOKENIZED : IndexEntry.Indexed.NO);
      fields.add(field);
    }
  }

    ...
    implements ExtensionService<DevInfProjectExt>
{
  ...
  private static final Map<String,String> DESCRIPTIONS = CollectionUtils.addAll(ExtensionServiceBase.DESCRIPTIONS, new String[][] {
      {DevInfProjectExt.PROPERTY_SCM_URL, "Browsable link to the project's source code repository"},
      {DevInfProjectExt.PROPERTY_SCM_LOCATIONS, "Source code repositories used by this project"},
      {DevInfProjectExt.PROPERTY_BUGTRACKER_URL, "Browsable link to the project's issue management system"},
      {DevInfProjectExt.PROPERTY_CI_URL, "Browsable link to the project's continous integration and build system"},
      {DevInfProjectExt.PROPERTY_METRICS_URL, "Browsable link to the project's quality metrics system"},
      {DevInfProjectExt.PROPERTY_REVIEW_URL, "Browsable link to the project's code review system"},

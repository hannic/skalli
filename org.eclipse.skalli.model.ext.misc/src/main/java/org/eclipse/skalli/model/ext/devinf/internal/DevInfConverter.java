...
class DevInfConverter extends AbstractConverter<DevInfProjectExt> {
  ...
  public static final String NAMESPACE = "http://xml.sap.com/2010/08/ProjectPortal/API/Extension-DevInf"; //$NON-NLS-1$
  ...
  private DevInfProjectExt iterateNodes(DevInfProjectExt ext, HierarchicalStreamReader reader, UnmarshallingContext context) {
    if (ext == null) {

...
public class PersistenceServiceXStreamTest {
  ...
  public void testResolveParentEntities() throws Exception {
    ...
    Assert.assertNull(p.getDeletedEntity(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[1]).getParentEntity());

    Assert.assertEquals(parent1, p.getEntity(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[2]).getParentEntity());
    Assert.assertEquals(entity1, p.getEntity(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[3]).getParentEntity());
    ...
    Assert.assertEquals(parent2, p.getDeletedEntity(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[5]).getParentEntity());

    // deleted entity MAY reference a non-deleted parent entity
    Assert.assertEquals(parent1, p.getDeletedEntity(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[6]).getParentEntity());
  }
  ...
  private ExtensionEntityBase createExtension(Class<? extends ExtensionEntityBase> clazz, boolean bool, String str, String... items)
  throws Exception {

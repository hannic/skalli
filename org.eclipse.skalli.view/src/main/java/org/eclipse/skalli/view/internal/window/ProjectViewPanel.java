  ...
  public ProjectViewPanel(ProjectApplication application, Navigator navigator, Project project) {
    ...
    for (final ProjectInfoBox projectInfoBox : infoBoxes) {
      ...
      Component content = projectInfoBox.getContent(project, new ExtensionUtil() {
        ...
        public ProjectTemplate getProjectTemplate() {
          if (projectTemplate == null) {
            ...
            projectTemplate = templateService.getProjectTemplateById(ProjectViewPanel.this.project.getProjectTemplateId());
          }
      ...
      if (StringUtils.isNotBlank(icon)) {
        infoBox.setIcon(new StreamResource(new ExtensionStreamSource(projectInfoBox.getClass(), icon), FilenameUtils.getName(icon), application));
      }

  ...
  private void render() {
      ...
      for(final Link link : links) {
        ...
        if (readOnly) {
          ...
          btnEditLink.addListener(new Button.ClickListener() {
            @Override
            public void buttonClick(ClickEvent event) {
              LinkWindow editLinkWindow = new LinkWindow(MultiLinkField.this, linkGroups.getItems(), linkGroup, link, MultiLinkField.this);
              editLinkWindow.show();
            }
          });
    ...
    if (!readOnly) {
      Button btnAddLink = new Button("Add Link", new Button.ClickListener() {
        @Override
        public void buttonClick(ClickEvent event) {
          LinkWindow addLinkWindow = new LinkWindow(MultiLinkField.this, linkGroups.getItems(), MultiLinkField.this);
          addLinkWindow.show();
        }
      });

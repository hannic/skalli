...
<%
    ...
    if (request.getAttribute(Consts.ATTRIBUTE_PROJECT)!=null) {
...
<%
  if (request.getParameter(Consts.PARAM_ACTION) != null
      && request.getParameter(Consts.PARAM_ACTION).equals(Consts.PARAM_VALUE_EDIT)) {

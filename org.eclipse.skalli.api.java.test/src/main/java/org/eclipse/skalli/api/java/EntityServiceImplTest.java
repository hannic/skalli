...
public class EntityServiceImplTest {
  ...
  public void testGetters() throws Exception {
    ...
    Assert.assertEquals(entities.get(0), entityService.loadEntity(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[0]));
  ...
  public void testPersist() throws Exception {
    ...
    expectLastCall();
    mockVS.queue(eq(new Validation<TestEntityBase1>(TestEntityBase1.class, PropertyHelperUtils.TEST_UUIDS[0], Severity.INFO, USERID)));
    expectLastCall();
  ...
  public void testValidate() throws Exception {
    ...
    AssertUtils.assertEquals("validate(invalid,WARNING)", expected ,entityService.validate(invalidEntity, Severity.WARNING));
  }
